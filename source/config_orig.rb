...
module RbConfig
  ...
  ApplicationAttended = true # bool
  # Location of running app:
  # "Unknown", "OnPremises", "OffPremises", "HomeInternet"
  ApplicationLocation = 'OnPremises'.freeze
  ...
  PINCapability = 'PINSupported'.freeze
  ...
  TxnData_ProcessMagensaTxn = true
  # Valid Values "Ecommerce", "MOTO", "Retail", "Restaurant"
  TxnData_IndustryType = 'Retail'.freeze
  # [Ecommerce : Ecommerce] [MOTO : MOTO] [Retail/Restaurant : Present]
  TxnData_CustomerPresent = 'Present'.freeze
